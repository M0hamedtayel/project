...
REDIS_QUEUE = os.getenv("REDIS_QUEUE", "queues:bot_b") # Queue to listen to
CALLBACK_URL = os.getenv("CALLBACK_URL", "http://192.168.52.1/api/v1/jobs/callback")
...
COMMAND_TEMPLATE = os.getenv("COMMAND_TEMPLATE", "python telegram-worker-b.py {value}")
