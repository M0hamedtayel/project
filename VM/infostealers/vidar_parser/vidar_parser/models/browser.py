...
class Cookie(BaseModel):
    ...
    expiry: datetime | None = Field(default=None, description="Parsed expiry datetime")
...
class HistoryEntry(BaseModel):
    """A single browser history URL entry (aggregated)."""
...
class AutofillEntry(BaseModel):
    ...
    browser: str
    profile: str
    entry: str = Field(description="Search query or form data entry")
