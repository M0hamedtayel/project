...
class Statistics(BaseModel):
    ...
    total_steam_accounts: int = 0
    total_2fa_secrets: int = 0
    # Context
    unique_browsers: int = 0
    unique_domains_in_credentials: int = 0
    notable_software_count: int = 0
    notable_process_count: int = 0
    # Flags
    has_real_credentials: bool = False
    has_google_tokens: bool = False
    has_steam_access: bool = False
    has_telegram_access: bool = False
    has_2fa_tokens: bool = False
